...
const Device = sequelize.define('device', {
    ...
    description: { type: DataTypes.STRING, autonull: true },
    price: { type: DataTypes.INTEGER, autonull: true },
    rating: { type: DataTypes.INTEGER, defaultValue: 0 },
    img: { type: DataTypes.ARRAY(DataTypes.TEXT), autonull: false }
})
...
const Rating = sequelize.define('rating', {
    id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    rate: { type: DataTypes.STRING, unique: true, autonull: false },
})
